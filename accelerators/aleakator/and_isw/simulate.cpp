...
#include "cxxrtl_and_isw.h"
#include "manager.h"

int main(int argc, char *argv[]) {
    Configuration config(argc, argv, Configuration::CircuitType::GADGET, "and_isw");
    ...
    std::cout << "c : " << simplify(*top.p_c0.getNode() ^ *top.p_c1.getNode()) << std::endl;
    std::cout << "a & b : " << (a & b) << std::endl;

    if (equivalence(simplify(*top.p_c0.getNode() ^ *top.p_c1.getNode()), (a & b)))
