...
bool prepare_step(Manager& manager, cxxrtl_design::p_top& top) {
    ...
    top.p_i__r.setNode(&symbol(("m" + std::to_string(manager.get_steps())).c_str(), 'M', 48));
...
int main(int argc, char *argv[]) {
    Configuration config(argc, argv, Configuration::CircuitType::ACCELERATOR, "prince_ti");
