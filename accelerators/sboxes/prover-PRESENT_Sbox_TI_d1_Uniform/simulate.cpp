...
#include "cxxrtl_prover-present_sbox_ti_d1_uniform.h"
#include "manager.h"
...
int main(int argc, char *argv[]) {
    Configuration config(argc, argv, Configuration::CircuitType::ACCELERATOR, "prover-present_sbox_ti_d1_uniform");
