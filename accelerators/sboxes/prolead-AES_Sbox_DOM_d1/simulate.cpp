...
#include "cxxrtl_prolead-aes_sbox_dom_d1.h"
#include "manager.h"
...
int main(int argc, char *argv[]) {
    Configuration config(argc, argv, Configuration::CircuitType::ACCELERATOR, "prolead-aes_sbox_dom_d1");
    ...
    int XxDI = X0 ^ (X1 << 8);
        ...
        top.p_XxDI.set<uint16_t>(XxDI);
        top.p_XxDI.setNode(&Concat(*ssec[0], *ssec[1]));
    #else
    ...
    Q0 = top.p_QxDO.get<uint16_t>() & 0xFF;
    Q1 = (top.p_QxDO.get<uint16_t>() & 0xFF00) >> 8;
